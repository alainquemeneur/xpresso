...
<body>\n\
   ...
   <div role=\"main\" class=\"ui-content\" data-theme=\"b\">\n\
	<p style=\"text-align:center\"><strong>%s : Ajouter un auteur</strong></p>\n",site,site);
	printf("<p style=\"text-align:center\"><strong>Nouvel auteur</strong></p>\n\
               <form autocomplete=\"off\" action=\"/cgi-bin/xpresso_saveauteur.cgi\" method=\"post\" id=\"form-save\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  ...
                  <input type=\"text\" name=\"txt-pseudo\" maxlength=\"100\" id=\"txt-pseudo\" value=\"\">\n\
                  </div>\n\
                  <div data-role=\"fieldcontain\">\n\
                  <label for=\"txt-mdp\">Mot de passe</label>\n\
                  <input type=\"password\" name=\"txt-mdp\" maxlength=\"100\" id=\"txt-mdp\" value=\"\">\n\
                  </div>\n",nom,mdp,site,code);
