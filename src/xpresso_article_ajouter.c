...
<body>\n\
   ...
   <div role=\"main\" class=\"ui-content\" data-theme=\"b\">\n\
	<p style=\"text-align:center\"><strong>%s : Ajouter un article</strong></p>\n",site,site);
	printf("<p style=\"text-align:center\"><strong>Nouvel article</strong></p>\n\
               <form autocomplete=\"off\" action=\"/cgi-bin/xpresso_savearticle.cgi\" method=\"post\" id=\"form-salons\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  ...
                  <input type=\"hidden\" name=\"txt-article\" id=\"txt-article\" value=\"0\">\n\
                  <div data-role=\"fieldcontain\">\n\
                  <label for=\"txt-titre\">Titre</label>\n\
                  <input type=\"text\" name=\"txt-titre\" maxlength=\"100\" id=\"txt-titre\" value=\"\">\n\
                  </div>\n\
                  <div data-role=\"fieldcontain\">\n\
                  <label for=\"textarea\">Contenu de l'article</label>\n\
                  <textarea name=\"textarea\" maxlength=\"20000\"></textarea>\n\
                  </div>\n\
                  <div data-role=\"fieldcontain\">\n\
                  <label for=\"txt-image\">URL image mise en avant</label>\n\
                  <input type=\"url\" name=\"txt-image\" maxlength=\"2560\" id=\"txt-image\" value=\"\">\n\
                  </div>\n",nom,mdp,site,code);
