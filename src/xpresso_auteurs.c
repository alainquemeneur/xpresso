   ...
   <div data-role=\"page\" data-theme=\"b\">\n\
      <div data-role=\"header\" data-position=\"fixed\" data-theme=\"b\">\n\
         <div data-role=\"navbar\">\n\
            <ul>\n\
               <li>\n\
                  <form action=\"/cgi-bin/xpresso_auteur_ajouter.cgi\" method=\"post\" id=\"form-ajouter\" data-transition=\"none\" data-rel=\"dialog\">\n\
         ...
         </div>\n",st->titrecomplet,nom,mdp,site,code);
         printf("<h1>%s</h1>\n",st->titrecomplet);
         printf("<h1>Auteurs</h1>\n</div>\n");
      printf("<div role=\"main\" class=\"ui-content\" data-theme=\"b\">\n");
      sprintf(query,"select pseudo from auteur where site=\'%s\';",site);
      db_query(handler,query);
