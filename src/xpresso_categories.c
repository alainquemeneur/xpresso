   ...
   <div data-role=\"page\" data-theme=\"b\">\n\
      <div data-role=\"header\" data-position=\"fixed\" data-theme=\"b\">\n\
         <div data-role=\"navbar\">\n\
            <ul>\n\
               <li>\n\
                  <form action=\"/cgi-bin/xpresso_categorie_ajouter.cgi\" method=\"post\" id=\"form-ajouter\" data-transition=\"none\" data-rel=\"dialog\">\n\
               ...
               <li>\n\
                  <form action=\"/cgi-bin/xpresso_categorie_supprimer.cgi\" method=\"post\" id=\"form-supprimer\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-mdp\" id=\"txt-mdp\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-site\" id=\"txt-site\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-comm-del-categorie\" id=\"txt-comm-del-categorie\" value=\"\">\n\
      ...
      for(i=0;i<db_ntuples(result);i++)
      	...
      	printf("<button onclick=\"document.getElementById('txt-comm-del-categorie').value = '%s';\" data-inline=\"true\" data-theme=\"d\" data-mini=\"true\">Sélectionner</button>\n<hr>\n",reponse);
      	}
      db_clear_result(result);
      printf("</div>\n\
