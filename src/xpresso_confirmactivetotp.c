...
printf("L'authentification à 2 facteurs protège l'accès à votre compte en ajoutant à votre login et mot de passe un code de vérification à 6 chiffres qui change toutes les 30 secondes.<br><br>Ce code TOTP (time one time password) vous sera donné par l'application \"Google authenticator\" à installer sur votre smartphone. Installez Google authenticator sur votre smartphone <strong>AVANT</strong> d'activer la fonctionnalité 2FA dans XpressO.<br><br>Si vous confirmez l'activation du 2FA, la page suivante vous donnera un QR code à faire lire à Google authenticator.");
printf("<form action=\"/cgi-bin/xpresso_activetotp.cgi\" method=\"post\" id=\"formconfirm\" data-transition=\"none\" data-rel=\"dialog\">\n\
	...
	<button type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-theme=\"c\" data-icon=\"action\">Confirmer l'activation du 2FA</button>\n\
	</form>\n",nom,mdp,site,code);
